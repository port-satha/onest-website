...
export default function Navbar({ onOpenModal }: { onOpenModal: () => void }) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-100 flex justify-between items-center px-6 md:px-12 py-5 bg-warm-white/92 backdrop-blur-[20px] border-b border-charcoal/6">
      ...
      {/* Mobile drawer */}
      {menuOpen && (
        <div className="absolute top-full left-0 right-0 bg-warm-white/98 backdrop-blur-[20px] border-b border-charcoal/6 flex flex-col items-center gap-6 py-8 md:hidden">
